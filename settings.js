...
global.owner = process.env.OWNER_NUMBER  || '233539958864' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=mRsUjawL#RVy3XhFrVt5qJ7yy_MudnYTGGeNbm1M7b3bXuTgHQok' ,
